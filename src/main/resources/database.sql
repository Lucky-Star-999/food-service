...
SELECT
	...
	ORDERFOOD.QUANTITY
FROM ORDERFOOD
	JOIN FOOD ON FOOD.ID = ORDERFOOD.FOODID
	JOIN SERVICEORDER ON SERVICEORDER.ID = ORDERFOOD.ORDERID
	JOIN RESTAURANT ON RESTAURANT.USERNAME = SERVICEORDER.RESTAURANTUSERNAME
WHERE ORDERFOOD.ORDERID = '6ff24c79-8a45-4023-9f87-aad4b9f8170a'
